...
namespace SorangonToolset.ArtToolset {
    ...
    /// </summary>
    [CreateAssetMenu(menuName = "Art Toolset/Generated Texture/Curve Texture", fileName = "NewCurveTexture", order = 800)]
    public class CurveTexture : GeneratedTexture1D {
        #region Settings
        [SerializeField] public AnimationCurve curve = AnimationCurve.EaseInOut(0f, 0f, 1f, 1f);
